...
require.register("jdate", function (exports, module) {
  module.exports = require('jdate.js');


});

require.register("converter.js", function (exports, module) {
  (function (root) {
...
require.register("jdate.js", function (exports, module) {
  /*
   * https://github.com/arashm/JDate
   * @author: Arash Mousavi
   * @version: 0.1.3
   */
  var jalali = require('converter.js');
  try {
