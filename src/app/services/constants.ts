...
export const API_URL_REGISTER: string = API_BASE_URL+'/api/register';
export const API_URL_ACTIVATE_ACCOUNT: string = API_BASE_URL+'/api/activate';
export const API_URL_REGEN_ACTIVATE_CODE: string = API_BASE_URL+'/api/activate/regenerate_key';
...
export const API_URL_CONFIRM_ORDER_BAG: string = API_BASE_URL+'/api/client/order-bags';
